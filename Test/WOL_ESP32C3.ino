...
const char* versionURL  = "<URL_TO_VERSION_TXT>";
const char* firmwareURL = "<URL_TO_FIRMWARE_BIN>";
...
// WOL CONFIG
// =======================
const IPAddress targetIP(192, 168, XXX, XXX); // opcional: podes colocar 0.0.0.0 para mascarar
const int udpPort = 9;
